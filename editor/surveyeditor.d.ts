/*Type definitions for Surveyjs Editor JavaScript library v1.0.1
...
export declare class SurveyQuestionEditorTab extends SurveyQuestionEditorTabBase {
    obj: Survey.Base;
    properties: SurveyQuestionEditorGeneralProperties;
    constructor(tabName: string, obj: Survey.Base, properties?: SurveyQuestionEditorGeneralProperties);
    readonly name: string;
    readonly htmlTemplate: string;
}
