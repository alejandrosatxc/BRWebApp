...
mr = (function (mr, $, window, document){
    ...
    mr.forms.documentReady = function($){
        $('form.custom-validate').attr('novalidate', true).off('submit').on('submit', mr.forms.custom_submit);
    ...
    mr.forms.custom_submit = function(e){
		...
		successText = thisForm.attr('data-success') ? thisForm.attr('data-success') : "Form successfully submitted";
		...
		jQuery.ajax({
			...
			error: function(errorObject, errorText, errorHTTP) {
				...
				formError.attr('original-error', formError.text());
				// Show the error with the returned error text.
				formError.text("There was an error processing your request.  Please try again later.");
				formSuccess.stop(true).fadeOut(1000);
				mr.forms.showFormError(formSuccess, formError, 1000, 5000, 500);
				submitButton.removeClass('btn--loading');
			}
